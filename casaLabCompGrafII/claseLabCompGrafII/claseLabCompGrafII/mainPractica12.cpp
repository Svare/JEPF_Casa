...
enum dirCarro {DERECHA1, ARRIBA, DIAGONAL, ARRIBA_DERECHA, DERECHA2, ABAJO_DERECHA, STOP};
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix(); //llanta frontal der
					...
					glRotatef(mcFlyP, 0.0, 0.0, -1.0);			// McFly
				...
				glPushMatrix(); //llanta frontal izq
					glTranslatef(6,-1,7.5);
					glRotatef(mcFlyN, 0.0, 0.0, 1.0);			// McFly
					glRotatef(180,0,1,0);
					glRotatef(rotTires,1,0,0);
					llanta.GLrender(NULL,_SHADED,1.0);
				glPopMatrix();
